package com.management.framework.web.domain;

import java.net.UnknownHostException;
import java.util.LinkedList;
import java.util.List;
import java.util.Properties;
import com.management.common.utils.Arith;
import com.management.common.utils.ip.IpUtils;
import com.management.framework.web.domain.server.Cpu;
import com.management.framework.web.domain.server.Jvm;
import com.management.framework.web.domain.server.Mem;
import com.management.framework.web.domain.server.Sys;
import com.management.framework.web.domain.server.SysFile;
